    ...
    ?>
        ...
        <div class="Page_wrapper">
            ...
            <div class="sign-in_Form">
                <form name="Sign-in" method="post" action="./member_modify.php">
                    <div class="sign-in_field">
                        <div class="sign-in_Required">아이디</div>
                        <?php echo $userid; ?>
                        <input name="ID" id="ID_hidden" type="hidden" value="<?php echo $userid; ?>"/>
                    </div>

                    <div class="sign-in_field">
                        <div class="sign-in_Required">비밀번호</div>
                        <input name="PW" id="PW" type="password" value="<?php echo $pass; ?>"/>
                    </div>

                    <div class="sign-in_field">
                        <div class="sign-in_Required">비밀번호 확인</div>
                        <input name="PW_check" id="PW_check" type="password" value="<?php echo $pass; ?>"/>
                    </div>
                        ...
                        <div class="sign-in_Address">
                            ...
                            <div class="sign-in_Address_address">
                                ...
                                <input
                                    ...
                                    type="text"
                                />
                                <input type="text" name="extr_info" id="extr_info">
                            </div>
                        </div>
                    </div>
                    <div class="sign-in_field">
                        <div class="sign-in_Required">나의 물 정보</div>
                        <input name="bottledwater" id="bottledwater" type="text" value="<?php echo $bottledwater; ?>"/>
                    </div>
